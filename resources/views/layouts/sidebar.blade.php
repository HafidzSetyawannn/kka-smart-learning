    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                ...
                @php
                    $isMateriMenu = request()->routeIs('materi.*') || request()->routeIs('kelas.materi.*'); // materi berdasarkan kelas
                @endphp
            ...
            <li class="nav-item">
                ...
                @php
                    $isKelasMenu =
                        ...
                        request()->routeIs('kelas.create') ||
                        request()->routeIs('kelas.edit') ||
                        request()->routeIs('kelas.show') ||
